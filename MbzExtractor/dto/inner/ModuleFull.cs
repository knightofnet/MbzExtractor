...
namespace MbzExtractor.dto.inner
{
    ...
    public class ModuleFull
    {
        ...
        [XmlElement(ElementName = "downloadcontent")]
        public string Downloadcontent { get; set; }
        [XmlElement(ElementName = "plugin_plagiarism_compilatio_module")]
        public Plugin_plagiarism_compilatio_module Plugin_plagiarism_compilatio_module { get; set; }
    ...
    [XmlRoot(ElementName = "plugin_plagiarism_compilatio_module")]
    public class Plugin_plagiarism_compilatio_module
    {
        [XmlElement(ElementName = "compilatio_configs")]
        public string Compilatio_configs { get; set; }
        [XmlElement(ElementName = "compilatio_files")]
        public string Compilatio_files { get; set; }
    }
}
